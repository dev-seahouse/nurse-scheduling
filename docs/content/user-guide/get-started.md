...
!!! warning "Protect scheduling data"
    ...
    optimization server. It also uses Google Analytics for analytics.
    **Anonymize schedule data** does not remove
...
3. Keep **Import Singapore holidays into date groups** enabled only when those
