...
// NEXT_PUBLIC_BACKEND_API_URL (falling back to the local default).
export const BACKEND_API_URL = normalizeEndpoint(process.env.NEXT_PUBLIC_BACKEND_API_URL || DEFAULT_BACKEND_API_URL);
