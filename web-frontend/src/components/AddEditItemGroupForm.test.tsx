...
describe('AddEditItemGroupForm', () => {
  ...
  it('renders item-specific details before the group selector', () => {
    render(
      <AddEditItemGroupForm
        mode={Mode.EDITING}
        ...
        onSave={() => undefined}
        onCancel={() => undefined}
        itemDetails={<div>Shift type details</div>}
      />,
    );

    expect(screen.getByText('Shift type details')).toBeInTheDocument();
