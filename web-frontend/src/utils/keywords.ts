...
// Fixed paid-leave credit for this pass: a leave day counts as 8h. Configurable
// leave credit is deferred (backlog); this constant feeds coefficient auto-fill.
export const LEAVE_CREDIT_MINUTES = 480;
...
export const AUTO_GENERATED_ITEMS: Record<DataType, AutoGeneratedItem[]> = {
  ...
  [DataType.SHIFT_TYPES]: [
    ...
    {
      id: LEAVE,
      description: 'Paid leave day-state'
    }
  ],
  [DataType.DATES]: []
};
