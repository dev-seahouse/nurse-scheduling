...
def test_cases_are_selected_by_id_and_by_category():
    ...
    assert {case.id for case in select(cases, [], [])} == {
        ...
        "dates-range-expand-singapore-detailed-yes",
        "dates-range-expand-singapore-no",
        "dates-range-expand-singapore-yes",
        "dates-range-shrink",
    ...
    assert {case.id for case in select(cases, [], [], ["singapore-holidays"])} == {
        "dates-range-expand-singapore-detailed-yes",
        "dates-range-expand-singapore-no",
        "dates-range-expand-singapore-yes",
...
def test_reference_digests_cover_every_file_hydrated_into_the_sandbox():
    ...
    expected.add(SINGAPORE_HOLIDAYS_SOURCE.name)
    expected.add(SINGAPORE_HOLIDAYS_FIXTURE.name)
